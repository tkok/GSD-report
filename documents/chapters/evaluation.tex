...
Note that the user interface is designed with "live auto complete functions" so that the user can easily set a desired sensor/actuator without knowing the exact name. (SEE FRONTEND DESIGN SECTION)
