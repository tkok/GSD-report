...
The ideas were broken into three main front-end pages\footnote{Front-end pages are dynamic HTML website.}, from where the user can control the policy engine and overlook its operation.
